...
const skills = [
    ...
    { name: "C", level: 75, icon: ( <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/c/c-original.svg" alt="C logo" className="w-6 h-6"/>),},
    { name: "VisualBasic", level: 75, icon: ( <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/visualbasic/visualbasic-original.svg" alt="VB logo" className="w-6 h-6" />),},
    { name: "C++", level: 65, icon: ( <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/cplusplus/cplusplus-original.svg" alt="Cplusplus logo" className="w-6 h-6" />),},
    { name: "Java", level: 65, icon: ( <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/java/java-original.svg" alt="Java logo" className="w-6 h-6" />),},
